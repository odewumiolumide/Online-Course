...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:05:12 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div class="white menu-init" id="main-menu">
            <nav id="menu-center">
              <ul>
                ...
                <li><a class="actived" href="#">About <i class="fa fa-angle-down"></i></a>
                <ul>
         ...
         <div class="row">
              ...
              <!-- article -->
               <article>
                  ...
                  <p>Luxury hotels, those exquisite havens of opulence and exclusivity, offer a host of advantages that elevate your travel experience to new heights. These establishments are not merely places to rest your head; they are immersive environments designed to pamper, delight, and create lasting memories. In this note, we delve
                     into the myriad advantages of luxury hotels that beckon discerning travelers to indulge in the ultimate getaway.
                  </p>
                </article>
              <!-- article -->
               ...
               <div class="row">
                    ...
                    <h3>2008</h3>
                    <span class="name">
                    <em>Online Marketing Entrepreneur</em>
                    </span>
                    </div>
                    ...
                    <h6>Successful rank in online marketing</h6>
                    <p>Otam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia, otam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo</p>
                    </div>
                    </div>
                    </div>
                    </div>
             ...
             <div class="col-md-3 onStep" data-animation="fadeInUp" data-time="600">
              <div class="widget">
                <ul id="services-list">
                  ...
                  <li>
                    <a href="service.html">Room 3 Column</a>
                  </li>

                  <li>
                    <a href="service-1.html">Room 2 Column</a>
                  </li>
              ...
              <div class="widget">
                <div class="download-brochure">
                  ...
                  <div class="btn-download onStep" data-animation="fadeInRight" data-time="600">
                    <a class="link-class" href="download.php">DOWNLOAD NOW</a>
                  </div>
                </div>
              </div>
            </div>
           ...
           <div class="item">
            <div class="team" style="background-image:url(img/team/img3.jpg)">
                  ...
                  <a href="#">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">ROOSEVELT VRIES
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">CEO LUXURY GROUP</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
                     </div>
                    </div>
                  </a>  
     ...
     <section id="brand" class="brand-page" aria-label="brands" style="background-image:url(img/bg-logo.jpg)">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-xs-12">
                ...
                <p>
                  Luxury hotels have long held a fascination for travelers seeking the pinnacle of comfort, opulence, and hospitality. These exclusive havens are designed to cater
                   to the most discerning of guests, offering a symphony of lavish experiences that leave a lasting impression.
                </p>
            </div>
            ...
            <div class="col-md-4 col-xs-12 col-md-offset-1">
                ...
                <address>
                  <span>129 Park street, Royal City, IB 10903</span> <span>PHONE: (+234) 100 888 999</span> <span>EMAIL : <a href=
                  "mailto:companyname@gmail.com">Luxury@gmail.com</a></span> <span>SITE : <a href="#">www.Luxury.com</a></span>
                </address>
            </div>
      ...
      <footer class="white">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              &copy; Luxury 2017. all reserved by Lorat Technology.
            </div>
