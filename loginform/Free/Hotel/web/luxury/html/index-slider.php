       ...
       <div class="item imgbg" style="background-image:url(img/bg-3.jpg)">
        ...
        <div class="overlay-main v-align text-center ">
          <div class="col-md-10 col-xs-11 onStep" data-animation="fadeInUp" data-time="300">
            ...
            <h1>PROVIDING COMFORTABLE</h1>
            <h3 >LUXURY RESIDENCE</h3>
            <br>
            <div class="star-content"><i class="fa fa-star-o" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> Five Star Luxury Hotel</div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
				...
				<div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step active" data-filter=".planing"><span>Choose Room</span></a>
					</div>
				</div>
                
                <div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step" data-filter=".que"><span>Fill Query</span></a>
					</div>
				</div>
                
                <div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step" data-filter=".book"><span>Booking</span></a>
					</div>
				</div>
                
                <div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step" data-filter=".finish"><span>Finish</span></a>
					</div>
				</div>
