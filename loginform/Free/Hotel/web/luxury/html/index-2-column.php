...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/index-2-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:02:00 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <section aria-label="home" class="mainbg-1" id="home">
        ...
        <!-- spacer end -->
          ...
          <!-- spacer end -->
            ...
            <h1 class="onStep" data-animation="animbouncefall" data-time="100">PROVIDING COMFORTABLE</h1>
            ...
            <div class="star-content onStep" data-animation="fadeInUp" data-time="600"> Five Star Luxury Hotel</div>
            
            <p class="content onStep" data-animation="fadeInUp" data-time="700"><i class="fa fa-check-square-o" aria-hidden="true"></i>
 Modern Luxury Hotel</p>
 
            <p class="content onStep" data-animation="fadeInUp" data-time="800"><i class="fa fa-check-square-o" aria-hidden="true"></i>
 Pleasure Relaxing Hotel</p>
 
            <p class="content onStep" data-animation="fadeInUp" data-time="900"><i class="fa fa-check-square-o" aria-hidden="true"></i>
 Rate And Reservation</p>
       ...
       <!-- booking home -->
        <div class="col-md-5 col-xs-12">
            ...
            <div id="reservation" class="imgbgres onStep" data-animation="fadeInUp" data-time="1200" >
