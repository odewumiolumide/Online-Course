    ...
    <section class="contact">
        <div class="container contact_container">
            <aside class="contact_aside">
                ...
                <h2>Contact Us</h2>
                <p>Accurate details ensures that businesses and individuals can reach each other promptly, facilitating timely updates,support, and 
                    relevant informations.Inaccurate contact information can lead to missed opportunties, delayed responses, and frustraion.
                </p>
