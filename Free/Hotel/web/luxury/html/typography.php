...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:05:12 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <div class="navbar-default-white navbar-fixed-top">
        ...
        <div class="row">
          ...
          <div class="white menu-init" id="main-menu">
            <nav id="menu-center">
            <ul>
                    <li><a href="index-rev-slider.php">Index Rev Slider</a></li>
                    <li><a href="index-slider.php">Index Slider</a></li>
                    <li><a href="index.php">Slider Text</a></li>
                    <li><a href="index-2-column.php">Index 2 column</a></li>
                ...
                <ul>
                    <li><a href="about.php">About Us - 1</a></li>
                    <li><a href="about-2.php">About Us - 2</a></li>
                    <li><a href="typography.php">All Elements</a></li>
                    
                  </ul>
                </li>
                 <li><a href="#">Services <i class="fa fa-angle-down"></i></a>
                  <ul>
                    <li><a href="service.php">Room 3 Column</a></li>
                    <li><a href="service-1.php">Room 2 Column</a></li>
                ...
                <li><a  href="#">Gallery <i class="fa fa-angle-down"></i></a> <ul>
                    ...
                    <li><a href="gallery-grid-2.php">Gallery 2 COL</a></li>
                    <li><a href="gallery-grid-3.php">Gallery 3 COL</a></li>
                    <li><a href="gallery-grid-4.php">Gallery 4 COL</a></li>
                    </ul>
                    </li>
                  </ul>
                </li>
  ...
  <div class="container">
    <div class="row">
              ...
              <div class="onStep" data-animation="fadeInUp" data-time="300">
                  ...
                  <h2>Unparalleled Comfort and Elegance</h2>
                  ...
                  <h1 class="alt-font">This is an alternative h1 heading</h1>
                  <h2 class="alt-font">This is an alternative h2 heading</h2>
                  <h3>This is an alternative h3 heading</h3>
                  <h4 class="alt-font">This is an alternative h4 heading</h4>
                  <h5 class="alt-font">This is an alternative h5 heading</h5>
                  <h6 class="alt-font">This is an alternative h6 heading</h6>
                  
                  <hr>
                  
                  <p class="lead">For those seeking to celebrate life's milestones or host important events, luxury hotels offer elegant venues and experienced event planners. Whether it's a grand wedding, a corporate retreat, or an intimate celebration, these hotels provide the perfect backdrop.</p>
                  <hr>
                  <p>Luxury hotels are typically located in prime areas, making it convenient to explore nearby attractions, restaurants, and shops. Their concierge services can help you navigate the local scene with ease.</p>
                  
                  <hr>
                  
                  <p class="alt-font-primary">
                    Luxury hotels are experts in crafting memorable experiences. Whether it's a surprise welcome amenity, a romantic turndown service, or a
                     personalized itinerary, they excel in creating moments that linger in your memory long after your stay.</p>
    ...
    <div id="accordion" class="panel-group">
        <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse">
                <div class="panel-body">
                    <p>HTML stands for HyperText Markup Language. HTML is the main markup language for describing the structure of Web pages. <a href="#" target="_blank">Learn more.</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in">
                <div class="panel-body">
                    <p>Bootstrap is a powerful front-end framework for faster and easier web development. It is a collection of CSS and HTML conventions. <a href="#">Learn more.</a></p>
                </div>
            </div>
        </div>
    ...
    <ul class="list-inline">
        ...
        <li><a href="#" data-toggle="tooltip" title="A much longer tooltip to demonstrate the max-width of the Bootstrp tooltip.">Large tooltip</a></li>
