...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/index-onepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:02:00 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
   ...
   <header class="init">
    ...
    <!-- subnav end -->
            ...
            <nav id="menu-center">
              <ul>
                ...
                <ul>
                    ...
                    <li><a href="Blog-post.php">Blog</a></li>
      ...
      <!-- home -->
      <section aria-label="home" class="mainbg-paralax parallax-window" data-parallax="scroll" data-image-src="img/bg-1.jpg" id="home">
      
        <!-- intro -->
        <div class="container">
        <div class="row">
        <div class="overlay-main-paralax v-align">
          <div class="col-md-10 col-xs-11">
            ...
            <div class="btn-content onStep" data-animation="fadeInUp" data-time="1200"><a href="Help.html">More Detail</a></div>
  ...
  <div class="container-fluid">
   <div class="row">
    ...
    <div class="image-container col-md-6 pull-left onStep" data-animation="fadeInLeft" data-time="0"></div>
      ...
      <!-- section room -->
      <section class="whitepage" id="service"> 
      ...
      <!-- subscribe -->
      <section class="subscribe-section parallax-window" data-parallax="scroll" data-image-src="img/subscribe-bg.jpg">
         <div class="container">
            <div class="row">
            ...
            <div class="col-md-6 subwrap">
             ...
             <form action="https://formspree.io/f/xdoqzpjw" id="subscribe" method="post" name="subscribe">
      ...
      <!-- section projects -->
      <section class="whitepage no-top" id="projects" aria-label="projects">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="onStep" data-animation="fadeInUp" data-time="300">
              <div class="filter-wraper text-center">
                <ul id="filter-porto">
                  ...
                  <li class="filt-projects" data-project=".rooms">ROOMS
                  </li>

                  <li class="filt-projects" data-project=".resto">RESTAURANT
                  </li>

                  <li class="filt-projects" data-project=".lands">LANDSCAPE
                  </li>

                  <li class="filt-projects" data-project=".spa">SPA
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="no-gutter onStep" data-animation="fadeInUp" data-time="600" id="projects-wrap">
              <div class="col-md-3 col-xs-12 item rooms">
              ...
              <div class="col-md-3 col-xs-12 item rooms resto">
                <div class="projects-grid big-img">
              ...
              <div class="col-md-3 col-xs-12 item lands">
                <div class="projects-grid big-img">
              ...
              <div class="col-md-3 col-xs-12 item spa">
                <div class="projects-grid big-img">
      ...
      <section id="brand" aria-label="brands" class="brand-page parallax-window" data-parallax="scroll" data-image-src="img/bg-logo.jpg">
        <!-- brands-->
          <div class="container">
            <div class="row">
     ...
     <section class="whitepage" id="blog">  
      <div class="container">
          <div class="row">
      ...
      <!-- map -->
      <section aria-label="map" class="no-top">
         <div class="onStep" data-animation="fadeInUp" data-time="300" id="map">
      </section>    
      <!-- map end -->
       
      <!-- section contact -->
      <section aria-label="contact" class="whitepage" id="contact">
        <div class="container">
          <div class="row">
    ...
    <!-- Reservation start -->
    <div class="white-popup-block mfp-hide animbounceInDown" data-time="0" id="reservation">
               ...
               <div class="col-sm-12 form-group">
                ...
                <div class="col-sm-12 form-group">
                  ...
                  <button class="btn-content" id="send" type="submit">BOOK NOW</button>
...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/index-onepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:03:33 GMT -->
</html>