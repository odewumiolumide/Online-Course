  ...
  <div class="container">
   ...
   <div class="col-md-6">
    <div class="room">
     ...
     <div class="heading"> Data Analyst</div>
     <div class="devider-rooms"></div>
     <div class="price">$280<sub>/ FREE</sub></div>
     ...
     <div class="btn-book"><a href="data-analyst.php">VIEW MORE</a></div>
    </div>
   </div>
   ...
   <div class="heading"> Digital Marketing Specialist </div>
     <div class="devider-rooms"></div>
     <div class="price">$400<sub>/ FREE</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="digital.php">VIEW MORE</a></div>
   </div>
   </div>
   ...
   <div class="heading"> Cloud Architect </div>
     <div class="devider-rooms"></div>
     <div class="price">$550<sub>/ FREE</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="cloud-architect.php">VIEW MORE</a></div>
   </div>
   </div>
   ...
   <div class="col-md-6">
    <div class="room">
     <img class="img-responsive" alt="room img" src="img/rooms/img1.jpg">
     <div class="heading"> Artifical Intelligence Engineer</div>
     <div class="devider-rooms"></div>
     <div class="price">$620<sub>/ FREE</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="Art-intel.php">VIEW MORE</a></div>
    </div>
   </div>
   ...
   <div class="room">
   <img class="img-responsive" alt="room img" src="img/rooms/img2.jpg">
   <div class="heading"> PMP PLUS </div>
     <div class="devider-rooms"></div>
     <div class="price">$675<sub>/ FREE</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="PMP PLUS.php">VIEW MORE</a></div>
   </div>
   </div>
   ...
   <div class="room">
   <img class="img-responsive" alt="room img" src="img/rooms/img2.jpg">
   <div class="heading"> Lean Six Sigma Expert </div>
     <div class="devider-rooms"></div>
     <div class="price">$605<sub>/ FREE</sub></div>
     <p class="content">Voluptatem accusantium doloremque totam rem aperiam, laudantium eaque ipsa quae ab illo inventore veritatis explicabo.</p>
     <div class="btn-book"><a href="Lean six.php">VIEW MORE</a></div>
   </div>
   </div>
