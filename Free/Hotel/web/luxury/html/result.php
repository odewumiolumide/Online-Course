...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/result.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:05:12 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <!-- subnav end -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12">
              <ul class="subdetail">
                <li>
                  <a href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//index-slider.php">Home</a>
                </li>
      ...
      <!-- section projects -->
      <section class="whitepage no-bottom no-top" id="projects" aria-label="projects">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="no-gutter onStep" data-animation="fadeInUp" data-time="600" id="projects-wrap">
              <div class="col-md-4 col-xs-12 item rooms">
              ...
              <div class="col-md-4 col-xs-12 item rooms resto">
                <div class="projects big-img">
              ...
              <div class="col-md-4 col-xs-12 item lands">
                <div class="projects big-img">
              ...
              <div class="col-md-4 col-xs-12 item spa">
                <div class="projects big-img">
