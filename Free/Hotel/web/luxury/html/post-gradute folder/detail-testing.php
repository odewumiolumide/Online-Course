      ...
      <section id="subheader">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1>
                   Introduction to CISSP Testing & Security
              </h1>
            </div>
      ...
      <div class="onStep" data-animation="fadeInUp" data-time="300">
        <div class="container">
          ...
          <div class="detaillist">
           <h2>Introduction to CISSP Testing & Security</h2>
           <div class="devider-rooms-detail"></div>
           <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magnaaliqua. Ut enim ad minim veniam, quis nstrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nullapariatur.
            </p><br>
          ...
          <span><i class="ti-check-box"></i> 2 Persons</span>
       ...
       <a class="btn-book-2 popup-form" href="#reservation">BOOK NOW</a>  
       </div>
       <!-- detail img end -->
