...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/index-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:01:29 GMT -->
<head>
    <meta charset="utf-8">
         ...
         <div class="col-md-6">
          <div class="left">
                            <div class="social-icons-subnav">
                                <div><i class="ti-mobile"></i><h4>Hi <?php echo $row["name"]; ?></h4></div>
    ...
    <!-- subnav end -->
      ...
      <div class="navbar-default-white navbar-fixed-top">
        ...
        <div class="row">
          ...
          <h4 style="color: #fff";>Hi <?php echo $row["name"]; ?></h4>
          
         <!---- <i class="ti-user"><h4 style="color: red";>Hi <?php echo $row["name"]; ?></h4></i>-->
          </a> 
          <!-- logo end -->
      ...
      <div id="owl-slider-home" class="owl-carousel">
       ...
       <div class="item imgbg" style="background-image:url(img/bg-3.jpg)">
        <!-- intro -->
        <div class="overlay-main v-align text-center ">
          <div class="col-md-10 col-xs-11 onStep" data-animation="fadeInUp" data-time="300">

            <h2>Advance to Master's Level Excellence</h1>
            <h4>Land your dream job by upskilling now! </h3>
            <br>
            <div class="star-content"><i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> Five Star Course Rate</div>
       ...
       <div class="item imgbg" style="background-image:url(img/bg-4.jpg)">
        <!-- intro -->
        <div class="overlay-main v-align text-center ">
          <div class="col-md-10 col-xs-11">

          <h2>Google Cloud courses are now on Skillup.</h1>
           <h4 >learn from Google Expert & Build Real-World Solutions.</h3>
          <br>
           <div class="star-content"><i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> Five Star Course Rate</div>
       ...
       <div class="item imgbg" style="background-image:url(img/bg-1.jpg)">
        <!-- intro -->
        <div class="overlay-main v-align text-center ">
          <div class="col-md-10 col-xs-11">
          
          <h2>Design Website like a pro with ChatGPT</h1>
          <h4 >Join Website Design Using chatGPT Course Now!</h3>
           <br>
           <div class="star-content"><i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> Five Star Course Rate</div>
      ...
      <section class="whitepage" id="about"> 
        ...
        <div class="container-fluid">
          ...
          <h2 style="text-align: center";>Recommended Courses</h3>
         ...
         <div class="col-md-4">
            ...
            <div class="wrap-news onStep" data-animation="fadeInLeft" data-time="300">
             ...
             <p>Qui ut ceteros comprehensam. Cu eos sale sanctus eligendi, id ius elitr saperet, ocurreret pertinacia pri an. No mei nibh consectetuer, semper laoreet perfecto ad qui, est rebum nulla argumentum ei. </p>
              <a class="link-class" href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/service.php">
              MORE DETAIL
           ...
           <div class="col-md-4">
            <div class="wrap-news onStep" data-animation="fadeInRight" data-time="900">
             ...
             <h3>Search Engine Optimizintaion</h3>
             <p>Qui ut ceteros comprehensam. Cu eos sale sanctus eligendi, id ius elitr saperet, ocurreret pertinacia pri an. No mei nibh consectetuer, semper laoreet perfecto ad qui, est rebum nulla argumentum ei. </p>
              <a class="link-class" href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/service.php">
              MORE DETAIL
              <span class="devider"></span>
      ...
      <section id="step-page" class="step-page">
         <div class="container">
            <div class="row">
              ...
              <div class="col-md-12">
				...
				<div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step active" data-filter=".planing"><span>Choose Course</span></a>
					</div>
				</div>
                
                <div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step" data-filter=".que"><span>Take Course</span></a>
					</div>
				</div>
                
                <div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step" data-filter=".book"><span>Exams</span></a>
					</div>
				</div>
                
                <div class="col-md-3 step-main">
					<div class="step-main">
						<a class="filt-step" data-filter=".finish"><span>Certified</span></a>
					</div>
				</div>
            ...
            <!-- step content -->  
            <div id="step-text" class="col-md-12 col-xs-12">
            ...
            <div class="projects-home" style="background-image:url(img/rooms/resto-room.jpg)">
                  ...
                  <a href="#">
                    <div class="overlay v-align">
                     <div class="content">
                     <span class="heading">Design Your UI/UX Career</span>
                     <span class="devider-projects"></span>
                     <span class="subheading">Get Started</span>
                     </div>
                    </div>
                  </a>  
                  </div>
           ...
           <div class="col-md-7">
            <div class="projects-home" style="background-image:url(img/rooms/com-room.jpg)">
                  ...
                  <a href="#">
                    <div class="overlay v-align">
                     <div class="content">
                     <h3 class="heading">Cloud Archiect Career 2024</h3>
                     <span class="devider-projects"></span>
           ...
           <div class="col-md-7">
            <div class="projects-home" style="background-image:url(img/rooms/rel-room.jpg)">
                  ...
                  <a href="#">
                    <div class="overlay v-align">
                     <div class="content">
                     <span class="heading">AI and ML Career with IIT</span>
                     <span class="devider-projects"></span>
                     <span class="subheading">Get Started</span>
                     </div>
                    </div>
           ...
           <div class="col-md-5">
            <div class="projects-home" style="background-image:url(img/rooms/beach.jpg)">
                  ...
                  <a href="#">
                    <div class="overlay v-align">
                     <div class="content">
                     <h3 class="heading">Masterclass to Boost Productivity</h3>
                     <span class="devider-projects"></span>
                     <p class="subheading">Get Started</p>
                     </div>
                    </div>
     ...
     <section class="subscribe-section" style="background-image:url(img/subscribe-bg.jpg)">
         <div class="container">
            ...
            <div class="col-md-6 subwrap">
             ...
             <form action="https://formspree.io/f/xdoqzpjw"  method="post" >
     ...
     <section class="whitepage">  
      <div class="container">
          ...
          <div class="col-md-12">
                <div class="text-center">
                  <h2>Courses Student are Learning</h2>
                 
                  <h3>Get Updated with the Lastest Skill</h3>
                  <span class="devider-center"></span>
                 </div>
         </div>
         ...
         <div class="owl-carousel" id="owl-post">
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img1.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-power-bi.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Power BI Beginners
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 1 day ago</div>
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img1.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-cloud.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Cloud Computing
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 2 days ago</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
                     </div>
                    </div>
                  </a>  
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img2.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-sql.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Introduction to SQL
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 3 days ago</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
                     </div>
                    </div>
                  </a>  
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img3.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost/PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-python.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Python for Beginners
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 2 days ago</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img1.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost//PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-data science.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Introdction to Data Analytics 
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 5 days ago</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
                     </div>
                    </div>
                  </a>  
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img2.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost//PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-cybercrime.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Introduction to Cybercrime
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 4 days ago</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
                     </div>
                    </div>
                  </a>  
           ...
           <div class="item">
            <div class="recent-post" style="background-image:url(img/recent/img3.jpg)">
                  <div class="hovereffect">
                  <a href="http://localhost//PORTAL/Free/Hotel/web/luxury/html//post-gradute%20folder/detail-IoT.php">
                    <div class="overlay ">
                     <div class="content">
                     <div class="heading">Introdction to IoT
                     <span class="devider-recent"></span>
                     </div>
                     <div class="subheading">Added 2 days ago</div>
                     <div class="readmore">Read more <i class="fa fa-angle-right"></i></div>
...
<!-- Mirrored from www.on3-step.com/tf/luxury/html/index-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 11:02:00 GMT -->
</html>