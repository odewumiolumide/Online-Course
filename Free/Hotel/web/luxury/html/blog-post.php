...
$message = "";
	...
	if(!($_POST['name']))
		...
		$query="INSERT INTO comment (name,date,email,message) VALUES('"
		.$_POST['name']."','"
		.$_POST['date']."','"
		.$_POST['email']."','"
		.$_POST['message']."'
                     ...
                     <div id="blog-comment">
                        ...
                        <ul>
                           <li>
                              ...
                              <div class="comment-info">
                                 <span class="c-name"> <?php echo $row["name"]; ?> </span></th></span>
                                 <span class="c-date">30 Jan 2017</span>
                                 <span class="c-reply"><a class="link"  href="#">Reply</a></span>
                              </div>
                              <div class="comment">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</div>
...
<td height="42" colspan="2" align="center" valign="middle"><hr />
                    ...
                    <table width="418" border="1" cellpadding="1" cellspacing="1">
                      <tr bgcolor="#000000">
                        ...
                        <th width="341" align="center" valign="middle" class="style10" scope="col">Date</th>
                        <th width="170" align="center" valign="middle" class="style10" scope="col">Email</th>
                        <th width="341" align="center" valign="middle" class="style10" scope="col">Message</th>
                        <th width="341" align="center" valign="middle" class="style10" scope="col"></th>
  ...
  ?>
                            ...
                            <tr bgcolor="#E2E2E2">
                              ...
                              <th height="23" align="center" valign="middle" scope="col"><?php echo $email; ?></th>
                              <th align="center" valign="middle" scope="col"><?php echo $message; ?></th>
                              <th align="center" valign="middle" bgcolor="#990000" scope="col"><a href="schbank.php?delete=<?php echo $id; ?>">d</a></th>
                            </tr>
                            <?php } ?>
                          </table></td>
                      </tr>
