...
<body>
    ...
    <nav>
        <div class="container nav_container">
            ...
            <button id="close-menu-btn"><i class="uil uil-multiply" style="font-size: 2rem;"></i></i></button>
        ...
        <div class="container header_container">
            <div class="header_left">
                  ...
                  <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam dicta 
                    ...
                    <a href="/PORTAL/Free/Hotel/web/luxury/html/register.php" class="btn btn-primary">Get Started</a>
            </div>
        ...
        <div class="container courses_conatiner">
            ...
            <article class="course">
                ...
                <div class="course_info">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A, voluptas. Veniam, cum. 
                        Temporibus officia, rem porro est aperiam illum pariatur dolorum maxime fugiat possimus a!</p>
                        <a href="courses-master.php" class="btn btn-primary">Learn More</a>
                </div>
            </article>
            ...
            <article class="course">
                ...
                <div class="course_info">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A, voluptas. Veniam, cum. 
                        Temporibus officia, rem porro est aperiam illum pariatur dolorum maxime fugiat possimus a!</p>
                        <a href="course-certification.php" class="btn btn-primary">Learn More</a>
